...
Namespace Data
    Partial Public Class GeneralAdo
        Private Class GeneralAdoState
            ...
            Public Shared Function GetFactory(ByVal _ProvName As String, ByVal _ConnStr As String) As GeneralAdoState
                Try
                    Dim ESqlState As New GeneralAdoState
