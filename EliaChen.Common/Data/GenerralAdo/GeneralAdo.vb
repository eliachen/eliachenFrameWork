...
Namespace Data
    Public Class GeneralAdo
        ...
        '数据库类型
        Private m_DbType As GeneralAdoDBTYPE
        ...
        ''' <remarks></remarks>
        Sub New(ByVal _ConnStr As String, ByVal _DBType As GeneralAdoDBTYPE)
            m_ConnStr = _ConnStr
            '对应的类型转换
        ...
        Public Function ExecuteSql(ByVal SQLString As String) As Integer
            Using ESqlState As GeneralAdoState = GeneralAdoState.GetFactory(m_ProviderName, m_ConnStr)
                Try
        ...
        Public Function ExecuteReader(ByVal strSQL As String) As DbDataReader
            Dim ESqlState As GeneralAdoState = GeneralAdoState.GetFactory(m_ProviderName, m_ConnStr)
