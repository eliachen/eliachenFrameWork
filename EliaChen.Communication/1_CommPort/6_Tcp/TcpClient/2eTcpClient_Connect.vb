...
#Region "Connect"
        Private Function eConnect() As SocketError
            Try
                ...
                '记录：
                CommLog.LogSuccess(Log.CommPortLogElement(Of TcpClientLog).MsgProcessDescriptionModel.connect,
            ...
            Catch exSk As SocketException
                ...
                CommLog.LogError(Log.CommPortLogElement(Of TcpClientLog).MsgProcessDescriptionModel.connect,
