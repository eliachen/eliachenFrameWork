...
#End Region
        ...
        Private Sub eSend_Queue(ByRef obj As Object, ByVal ArrByte As Byte()) Handles Me.mEventSend
            Try
                ...
                '发送
                Dim eSendS As New eTcpClientState(ArrByte)
                ...
                If eSendS.ErrSocket <> SocketError.Success Then
                    '记录
                    CommLog.LogError(Log.CommPortLogElement(Of eTcpClientLog).MsgProcessDescriptionModel.send,
                                                                      New eTcpClientLog(eSendS.ErrSocket))
                End If
