...
#Region " Recv"
        ...
        Public Sub CirclRecv()
            Try
                '记录：
                CommLog.LogSuccess(Log.CommPortLogElement(Of TcpClientLog).MsgProcessDescriptionModel.recv,
                                   New TcpClientLog(Me.ActivatedSocketState, "开始接收"))
                '初始化接收定时器
                ...
                AddHandler Timer_Recv.Elapsed, Sub(sender As Object, e As Timers.ElapsedEventArgs)
                                                   ...
                                                   Catch exSk As SocketException
                                                       '记录
                                                       CommLog.LogError(Log.CommPortLogElement(Of TcpClientLog).MsgProcessDescriptionModel.recv,
                                                                                                         New TcpClientLog(exSk.SocketErrorCode))
        ...
        Public Overloads Function Receive() As Byte() Implements ICommPort.Receive
            ...
            Try
                Using RecvClient As New TcpClientState
